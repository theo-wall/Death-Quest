    ...
    nomatch.addEventListener('click', function() {
      ...
      if (playerChoice === checkIfArrayIsUnique(diceRoll)) {
        ...
        content.innerHTML = `    
          ...
          <div id="content">
            <p id="flavour">
              the Necromancer shows you the dice and they come up ${diceRoll[0]}, ${diceRoll[1]}, ${diceRoll[2]}, ${diceRoll[3]}, ${diceRoll[4]}, ${diceRoll[5]}. You Win The, <span id='ruby'>ruby</span>.
            </p>
          </div>
